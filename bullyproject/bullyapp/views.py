...
# a view take a web request and returns a web response (web content, redirect...)
# render returns an http response with that given context ... need request and template_name, possibly context 
